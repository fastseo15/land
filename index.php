...
$baseAuthor = $BRAND;
$URL  = "https://sipp.pa-banjarkota.go.id/common/?layanan=$BRAND";
$PAGEURL = "https://sipp.pa-banjarkota.go.id/common/?layanan=$BRAND";
$AMP = "https://banjarkotasipp.pages.dev/?layanan=$BRAND";
$DAFTAR = "https://banjarkotasipp.pages.dev/";
$BANNER = "https://i.pinimg.com/736x/c4/59/02/c45902a161392f04ded3982a48760c90.jpg";
$LOGO = "https://i.pinimg.com/236x/c6/56/84/c65684387f069869eb06bc4597f67af4.jpg";
$keyword = "$brand, login $brand, daftar $brand, situs $brand, rtp $brand, link alternatif $brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND: Website SIPP Pengadilan Agama Kota Banjar";
    $DESCRIPTION = "$BRAND adalah platform resmi SIPP Pengadilan Agama Kota Banjar yang memudahkan akses informasi dan layanan hukum secara online. Dengan antarmuka yang ramah pengguna, Anda dapat dengan cepat menemukan data perkara, jadwal sidang, dan informasi penting lainnya. Keamanan dan keakuratan data menjadi prioritas, menjamin layanan yang terpercaya dan efisien. Bergabunglah untuk pengalaman hukum yang lebih mudah dan transparan.";
    $description = "$BRAND adalah platform resmi SIPP Pengadilan Agama Kota Banjar yang memudahkan akses informasi dan layanan hukum secara online. Dengan antarmuka yang ramah pengguna, Anda dapat dengan cepat menemukan data perkara, jadwal sidang, dan informasi penting lainnya. Keamanan dan keakuratan data menjadi prioritas, menjamin layanan yang terpercaya dan efisien. Bergabunglah untuk pengalaman hukum yang lebih mudah dan transparan.";
}
...
<!doctype html>
  ...
  .n-columns-2 {
    ...
    .login, .login-button {
      background: linear-gradient(to bottom, #00c4ff 0%, #000000 100%);
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $URL ?>" data-animation-role="header-element">
                      ...
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://i.pinimg.com/236x/c6/56/84/c65684387f069869eb06bc4597f67af4.jpg"
